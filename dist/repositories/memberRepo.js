...
const generateFixedMemberMockData = () => {
    const mockData = { id: 0, account: `t${mockMemberCount}`, password: '123', male: true, email: `t${mockMemberCount}@gmail.com`, name: `${mockMemberCount}_name`, exp: mockMemberCount };
    const mockMember = Object.assign(new Member_1.Member(), mockData);
    return Object.assign({}, mockMember);
};
